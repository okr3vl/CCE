...
Author : okr3vl                  
Team   : [HKG]                   
Github : https//github.com/okr3vl/\n\n";
...
while(1){
    ...
    if($response->error != null){
        echo "\e[31m[DEAD] \e[00m".$card."|".$month."/".$year."|".$cvv."\n";
    }else{
        echo "\e[92m[LIVE] \e[00m".$card."|".$month."/".$year."|".$cvv."\n";
        $o = fopen("result.txt", 'a');
